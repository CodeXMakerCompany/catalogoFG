	...
	<div class="row">
		...
		<ul>
			...
			<li>
				...
				<img src="http://localhost/catalogoFig/backend/vistas/img/slide/default/back_default.jpg">

				<div class="slideOpciones slideOpcion1">
					
					<img class="imgProducto" src="http://localhost/catalogoFig/backend/vistas/img/slide/slide1/zapatos.png" style="top:15%; right:10%; width:45%">

					<div class="textosSlide" style="top:20%; left:10%; width:40%">
						
						<h1 style="color:#333">Bienvenido</h1>

						<h2 style="color:#777">Checa nuestro catálogo</h2>
			...
			<li>
				...
				<div class="slideOpciones slideOpcion2">
					...
					<img class="imgProducto" src="http://localhost/catalogoFig/backend/vistas/img/slide/slide2/curso.png" style="top:5%; left:15%; width:25%">
			...
			<li>
				...
				<img src="http://localhost/catalogoFig/backend/vistas/img/slide/slide3/fondo2.jpg">

				<div class="slideOpciones slideOpcion2">
					
					<img class="imgProducto" src="http://localhost/catalogoFig/backend/vistas/img/slide/slide3/iphone.png" style="top:5%; left:15%; width:25%">
